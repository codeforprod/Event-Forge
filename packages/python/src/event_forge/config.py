...
class OutboxConfig:
    ...
    """Polling interval in seconds (default: 300.0 = 5 min). Deprecated: use safety_net_interval."""

    safety_net_interval: float = 300.0
    """Safety net polling interval in seconds for crash recovery (default: 300.0 = 5 min)."""
